...
export class MarioServiceProvider {
  ...
  allCharacters(): MkItem[] {
    return [
      ...
      { itemType: 'm', name: 'Larry', image: '32px-MK8_Larry_Icon.png' },
      { itemType: 'm', name: 'Wendy', image: '32px-MK8_Wendy_Icon.png' },
      { itemType: 'm', name: 'Isabelle', image: '32px-MK8_Isabelle_Icon.png' },
      ...
      { itemType: 'l', name: 'Metal Mario', image: '32px-MK8_MMario_Icon.png' },
      { itemType: 'm', name: 'Yoshi', image: '32px-MK8_Yoshi_Icon.png' },
      { itemType: 'l', name: 'Pink Gold Peach', image: '32px-MK8_PGPeach_Icon.png' },
      { itemType: 'm', name: 'Iggy', image: '32px-MK8_Iggy_Icon.png' },
      { itemType: 'l', name: 'Ludwig', image: '32px-MK8_Ludwig_Icon.png' },
      ...
      { itemType: 'm', name: 'Rosalina', image: '32px-MK8_Rosalina_Icon.png' },
